...
class EnclaveCryptoManager final {
 ...
 public:
  ...
  std::string aes_128_gcm_decrypt(const std::string& message);
  std::string aes_128_gcm_encrypt(const std::string& message);

  std::string aes_encrypt(unsigned char* aes_key, unsigned char* iv, std::string& message);
};
