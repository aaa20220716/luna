...
SGX_COMMON_FLAGS += -Wall -Wextra -Winit-self -Wpointer-arith -Wreturn-type \
                    ...
                    -Wcast-align -Wno-cast-qual -Wno-unused-variable \
										...
										-I$(INCLUDE_PATH) -I$(COMMON_INCLUDE_PATH) -I/usr/include/mysql\
...
App_Link_Flags := -L../../lib -L$(SGX_LIBRARY_PATH) -l$(Urts_Library_Name) -lpthread -lsgx_pthread\
								  -lsgx_ukey_exchange -lservice_provider\
									...
									$(GRPC_LINK_FLAGS) -lpthread\
           				-Wl,--no-as-needed -lgrpc++_reflection -Wl,--as-needed\
           				-ldl -lgflags -llz4 -L/usr/lib/mysql -lmysqlclient
...
ifneq ($(SGX_MODE), HW)
	...
	App_Link_Flags += -L/usr/lib/x86_64-linux-gnu -lprotobuf -lsgx_epid -lsgx_quote_ex
endif
